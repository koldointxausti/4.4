					...
					case "2": // view teachers info
						if (school.getTeachers().size() > 0) {
							...
							if (teacherIndex >= 0) {
								...
								String date = school.getTeacher(teacherIndex).getBirthDate().get(Calendar.DAY_OF_MONTH)
								...
								System.out
										.println("Phone number:\t " + school.getTeacher(teacherIndex).getPhoneNumber());
								...
								for (int i = 0; i < school.getTeacher(teacherIndex).getSubjects().size(); i++)
									System.out.println("Subjects:\t" + school.getTeacher(teacherIndex).getSubject(i));
							} else
						...
						if (school.getTeachers().size() > 0) {
							...
							if (teacherIndex >= 0) {
								...
								while (modifyRepeat) {
									...
									case "5": // salary
										System.out.println(
												"Your actual salary is " + school.getTeacher(teacherIndex).getSalary()
									...
									case "6": // subjects
										...
										for (int i = 0; i < school.getTeacher(teacherIndex).getSubjects().size(); i++)
											System.out.println("\t" + school.getTeacher(teacherIndex).getSubject(i));
							...
							if (administrativeIndex >= 0) {
								...
								while (modifyRepeat) {
									...
									case "2": // birth date
										...
										Calendar birthDate = new Calendar.Builder().setCalendarType("iso8601")
												.setDate(year, month, day).build();
										while (!school.getAdministrative(administrativeIndex).checkDate(birthDate)) {
											System.out.println("Enter a valid date");
											System.out.println("year:");
											year = sc.nextInt();
											System.out.println("month:");
