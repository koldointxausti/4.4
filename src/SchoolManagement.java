					...
					while (teachersRepeat) {
						...
						case "2": // view teachers info
							if (school.getTeachers().size() > 0) {
								...
								int teacherIndex = school.findTeacher(sc.next().toUpperCase());
								sc.nextLine();
								System.out.println(teacherIndex);
								if (teacherIndex >= 0) {
									System.out.println("Name:\t" + school.getTeacher(teacherIndex).getName());
									String date = school.getTeacher(teacherIndex).getBirthDate()
											.get(Calendar.DAY_OF_MONTH) + "/"
											+ school.getTeacher(teacherIndex).getBirthDate().get(Calendar.MONTH) + "/"
											+ school.getTeacher(teacherIndex).getBirthDate().get(Calendar.YEAR);
									System.out.println("Birth date:\t" + date);
									System.out.println("Dni:\t" + school.getTeacher(teacherIndex).getDni());
									System.out.println(
											"Phone number:\t " + school.getTeacher(teacherIndex).getPhoneNumber());
									System.out.println("Salary:\t " + school.getTeacher(teacherIndex).getSalary());
									date = school.getTeacher(teacherIndex).getJoined().get(Calendar.DAY_OF_MONTH) + "/"
											+ school.getTeacher(teacherIndex).getJoined().get(Calendar.MONTH) + "/"
											+ school.getTeacher(teacherIndex).getJoined().get(Calendar.YEAR);
									System.out.println("Joined date:\t" + date);
									if (school.getTeacher(teacherIndex).isTutor())
										System.out.println("Tutor of:\t" + school.getTeacher(teacherIndex).getTutor());
									for (int i = 0; i < school.getTeacher(teacherIndex).getSubjects().size(); i++)
										System.out
												.println("Subjects:\t" + school.getTeacher(teacherIndex).getSubject(i));
								} else
							...
							if (school.getTeachers().size() > 0) {
								...
								if (teacherIndex >= 0) {
									...
									while (modifyRepeat) {
										...
										case "1": // name
											System.out.println(
													"Your actual name is " + school.getTeacher(teacherIndex).getName()
															+ "\nEnter the new name bellow:");
											String possibleName = sc.next();
											sc.nextLine();
											while (!school.getTeacher(teacherIndex).checkName(possibleName)) {
												System.out.println("Enter a valid name (no numbers)");
												possibleName = sc.next();
												sc.nextLine();
											}
											school.getTeacher(teacherIndex).setName(possibleName);
											System.out.println("Done.");
											break;
										case "2": // birth date
											String date = school.getTeacher(teacherIndex).getBirthDate()
											...
											while (!school.getTeacher(teacherIndex).checkDate(birthDate)) {
											...
											school.getTeacher(teacherIndex).setBirthDate(birthDate);
											System.out.println("Done.");
											break;
										case "3": // dni
											System.out.println(
													"Your actual dni is " + school.getTeacher(teacherIndex).getDni()
															+ "\nEnter the new dni bellow:");
											String dni = sc.next();
											sc.nextLine();
											while (!school.getTeacher(teacherIndex).checkDni(dni)) {
												System.out.println("Enter a valid DNI");
												dni = sc.next();
												sc.nextLine();
											}
											school.getTeacher(teacherIndex).setDni(dni);
											System.out.println("Done.");
											break;
										case "4": // phone number
											System.out.println("Your actual phone number is "
													+ school.getTeacher(teacherIndex).getPhoneNumber()
													+ "\nEnter the new phone number bellow:");
											String phoneNumber = sc.next();
											sc.nextLine();
											while (!school.getTeacher(teacherIndex).checkPhoneNumber(phoneNumber)) {
												System.out.println("Enter a valid phone number");
												phoneNumber = sc.next();
												sc.nextLine();
											}
											school.getTeacher(teacherIndex).setPhoneNumber(phoneNumber);
											System.out.println("Done.");
											break;
										case "5": // salary
											System.out.println("Your actual salary is "
													+ school.getTeacher(teacherIndex).getSalary()
													+ "\nEnter the new salary bellow:");
											double salary = sc.nextDouble();
											while (!school.getTeacher(teacherIndex).checkSalary(salary)) {
												System.out.println("Enter a valid salary");
												salary = sc.nextDouble();
											}
											school.getTeacher(teacherIndex).setSalary(salary);
											System.out.println("Done.");
											break;
										case "6": // subjects
											System.out.println("Your actual subjects are ");
											for (int i = 0; i < school.getTeacher(teacherIndex).getSubjects()
													.size(); i++)
												System.out
														.println("\t" + school.getTeacher(teacherIndex).getSubject(i));
											System.out.println("How many subjects are you teaching now?");
											int numberOfSubjects = sc.nextInt();
											for (int i = 0; i < numberOfSubjects; i++) {
												System.out.println("enter one subject");
												school.getTeacher(teacherIndex).addSubject(sc.next());
												sc.nextLine();
											}
											break;
										}
					...
					while (studentsRepeat) {
						...
						case "2": // view students info
							if (school.getStudents().size() > 0) {
								...
								int studentIndex = school.findStudent(sc.next().toUpperCase());
								sc.nextLine();
								...
								if (studentIndex >= 0) {
									...
									System.out.println(
											"Phone number:\t " + school.getStudent(studentIndex).getPhoneNumber());
									...
									System.out.println(
											"Mark average:\t" + school.getStudent(studentIndex).getMarkAverage());
								...
								if (studentIndex >= 0) {
									...
									while (modifyRepeat) {
										...
										case "2": // birth date
											...
											Calendar birthDate = new Calendar.Builder().setCalendarType("iso8601")
													.setDate(year, month, day).build();
											while (!school.getStudent(studentIndex).checkDate(birthDate)) {
												System.out.println("Enter a valid date");
												System.out.println("year:");
												year = sc.nextInt();
												System.out.println("month:");
										...
										case "7": // markAverage
											...
											break;
										case "8": // course
											System.out.println("Your actual course is "
													+ school.getStudent(studentIndex).getCourse()
								...
								if (studentIndex >= 0) {
									...
									if (tutorIndex >= 0)
										System.out.println("The tutor of " + school.getStudent(studentIndex).getName()
												+ " is " + school.getTeacher(tutorIndex).getName() + ", "
												+ school.getTeacher(tutorIndex).getTeacherID());
									else
...
//ADMINISTRATIVES
					...
					while (administrativesRepeat) {
						...
						case "2": // view administratives info
							if (school.getAdministratives().size() > 0) {
								...
								int administrativeIndex = school.findAdministrative(sc.next().toUpperCase());
								sc.nextLine();
								System.out.println(administrativeIndex);
								if (administrativeIndex >= 0) {
									System.out.println(
											"Name:\t" + school.getAdministrative(administrativeIndex).getName());
									...
									System.out.println("Birth date:\t" + date);
									System.out
											.println("Dni:\t" + school.getAdministrative(administrativeIndex).getDni());
									...
									date = school.getAdministrative(administrativeIndex).getJoined()
											.get(Calendar.DAY_OF_MONTH)
											+ "/"
											+ school.getAdministrative(administrativeIndex).getJoined()
													.get(Calendar.MONTH)
											+ "/" + school.getAdministrative(administrativeIndex).getJoined()
													.get(Calendar.YEAR);
									System.out.println("Joined date:\t" + date);
									...
									while (modifyRepeat) {
										...
										case "6": // languages
											...
											for (int i = 0; i < school.getAdministrative(administrativeIndex)
												...
												System.out.println("\t" + school.getAdministrative(administrativeIndex)
														.getLanguages()[i]);
											System.out.println("How many subjects are you teaching now?");
											...
											for (int i = 0; i < numberOfLanguages; i++) {
												...
												school.getAdministrative(administrativeIndex).addLanguages(sc.next());
												sc.nextLine();
						...
						case "5": // new administrative
							...
							Calendar joined = new Calendar.Builder().setCalendarType("iso8601")
									.setDate(year, month, day).build();
							while (!administrative.checkDate(joined)) {
								System.out.println("Enter a valid date");
								System.out.println("year:");
								year = sc.nextInt();
								System.out.println("month:");
			...
			System.out.println("You have to be ovet 18 to use this program");
	}
